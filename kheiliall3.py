...
# تغییر رنگ و merge کردن خط اول
workbook = openpyxl.load_workbook(file_name)
worksheet = workbook.active
worksheet.merge_cells('A1:I1')  # ادغام سلول‌های A1 تا I1
first_row = worksheet['A1']  # تنها از یک سلول برای خط اول استفاده می‌کنیم
first_row.fill = PatternFill(start_color="7F7F7F", end_color="7F7F7F", fill_type="solid")
first_row.alignment = Alignment(horizontal='center', vertical='center')
first_row.value = 'هورا'  # تنظیم مقدار در سلول A1
workbook.save(file_name)

# تغییر رنگ خط دوم به طوسی
second_row = worksheet[2]
